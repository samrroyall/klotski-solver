  ...
  render() {
    return (
      <div id="content-wrapper">
        <div className="h1 text-center mt-1 mb-0" id="header">{this.state.displayText}</div>
        <div className="row justify-content-center px-0 mx-0">
          ...
          <Toolbar show={this.state.currState === "cleared" || this.state.currState === "blocksAdded"}
            onDragFunc={this.dragBlockInfo}
          />
        </div>
        <footer className="mt-5 text-center text-secondary">Developed by Sam Royall</footer>
      </div>
    );   
  }
}
